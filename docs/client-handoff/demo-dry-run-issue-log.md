...
| 006 | BLOCKING | Scripts | Backend scripts (check/fix/reset) lacked safety guards and printed PHI (patient names). | Risk of accidental production data loss or PHI leak. | Implemented `demo-safety-guard.ts` and aggregate-only logging. | RESOLVED |
