    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'branch-admin', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><BranchAdminDashboard /></LazyPage></PermissionRoute> },
          { path: 'branch-admin/staff', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><WIPPage /></LazyPage></PermissionRoute> },
          { path: 'branch-admin/departments', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><WIPPage /></LazyPage></PermissionRoute> },
          { path: 'branch-admin/rooms', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><WIPPage /></LazyPage></PermissionRoute> },
          { path: 'branch-admin/schedules', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><WIPPage /></LazyPage></PermissionRoute> },
          { path: 'branch-admin/services', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><WIPPage /></LazyPage></PermissionRoute> },
          { path: 'branch-admin/equipment', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><WIPPage /></LazyPage></PermissionRoute> },
          { path: 'branch-admin/inventory-rules', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><WIPPage /></LazyPage></PermissionRoute> },
          { path: 'branch-admin/billing-rules', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><WIPPage /></LazyPage></PermissionRoute> },
          { path: 'branch-admin/queue-settings', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><WIPPage /></LazyPage></PermissionRoute> },
          { path: 'branch-admin/approvals', element: <PermissionRoute allowedRoles={['Super Admin', 'Branch Admin']}><LazyPage><WIPPage /></LazyPage></PermissionRoute> },
