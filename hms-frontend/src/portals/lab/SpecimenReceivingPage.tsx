    ...
    <div className="space-y-4 animate-fade-in font-sans">
      ...
      <HmsDashboardShell footer={<HmsAuditFooter dataSource="Laboratory LIS Service" lastRefreshed={new Date()} />}>
        {isLoading ? (
          ...
          <HmsDataUnavailable sectionName="Specimen Receiving" expectedApi="GET /api/v1/lab/specimens/pending" />
        ) : specimens.length === 0 ? (
          <HmsDataUnavailable sectionName="Pending Specimens" expectedApi="GET /api/v1/lab/specimens/pending" />
        ) : (
