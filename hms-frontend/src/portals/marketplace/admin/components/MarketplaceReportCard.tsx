  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button type="button" disabled title="Marketplace report export endpoint is not available yet." className="flex cursor-not-allowed items-center gap-2 px-4 py-2.5 bg-slate-100 border border-slate-200 rounded-xl text-xs font-black text-slate-400">
          Export Report WIP
        </button>
      </div>
