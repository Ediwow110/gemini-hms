    ...
    >
      <div className="space-y-6 pb-12">
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
          <ChartCard title="GMV trend" description="Gross marketplace volume trend (prototype data)." height={300}><TrendLineChart data={gmvTrend} title="GMV trend" valueLabel="₱M" /></ChartCard>
