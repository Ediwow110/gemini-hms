...
export const ApprovalCenterPage: React.FC = () => {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-black text-slate-800 tracking-tight">Approval Center</h2>
        <p className="text-xs text-slate-500 font-medium">Cross-domain approval queue with role-aware filtering</p>
      </div>
