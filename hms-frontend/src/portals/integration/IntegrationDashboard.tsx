    ...
    <HmsDashboardShell widthTier="full">
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 xl:col-span-4 flex flex-col">
          <div className="bg-slate-50 border border-slate-300 rounded-md p-6 text-slate-700 space-y-3 shadow-sm flex-grow flex flex-col justify-between">
            <div>
            ...
            <button
              ...
              className="w-full py-3 bg-white hover:bg-slate-50 border border-slate-300 rounded-md text-xs font-bold text-slate-700 transition-colors flex items-center justify-center gap-2 cursor-pointer mt-4"
            >
        ...
        <div className="col-span-12 bg-white border border-slate-300 rounded-md p-6 shadow-sm">
          <h3 className="text-xs font-bold text-slate-800 uppercase tracking-wide mb-4 flex items-center gap-2">
            <div className="h-4 w-1 rounded-full bg-sky-600" /> Quick Actions
          </h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            <button onClick={() => navigate('/integration/notifications')} className="flex flex-col items-center justify-center p-4 bg-slate-50 border border-slate-300 rounded-md hover:border-sky-400 hover:bg-sky-50 transition-all group cursor-pointer">
              <Bell className="h-5 w-5 text-slate-400 group-hover:text-sky-600 mb-2" />
              <span className="text-[10px] font-bold text-slate-600 uppercase">Notifications</span>
            </button>
            <button onClick={() => navigate('/integration/approvals')} className="flex flex-col items-center justify-center p-4 bg-slate-50 border border-slate-300 rounded-md hover:border-sky-400 hover:bg-sky-50 transition-all group cursor-pointer">
              <ShieldCheck className="h-5 w-5 text-slate-400 group-hover:text-sky-600 mb-2" />
              <span className="text-[10px] font-bold text-slate-600 uppercase">Approvals</span>
            </button>
            <button onClick={() => navigate('/integration/global-search')} className="flex flex-col items-center justify-center p-4 bg-slate-50 border border-slate-300 rounded-md hover:border-sky-400 hover:bg-sky-50 transition-all group cursor-pointer">
              <BarChart3 className="h-5 w-5 text-slate-400 group-hover:text-sky-600 mb-2" />
              <span className="text-[10px] font-bold text-slate-600 uppercase">Global Search</span>
            </button>
            <button onClick={() => navigate('/integration/patient-timeline')} className="flex flex-col items-center justify-center p-4 bg-slate-50 border border-slate-300 rounded-md hover:border-sky-400 hover:bg-sky-50 transition-all group cursor-pointer">
              <Users className="h-5 w-5 text-slate-400 group-hover:text-sky-600 mb-2" />
              <span className="text-[10px] font-bold text-slate-600 uppercase">Patient Timeline</span>
            </button>
            <button onClick={() => navigate('/integration/reconciliation')} className="flex flex-col items-center justify-center p-4 bg-slate-50 border border-slate-300 rounded-md hover:border-sky-400 hover:bg-sky-50 transition-all group cursor-pointer">
              <TrendingUp className="h-5 w-5 text-slate-400 group-hover:text-sky-600 mb-2" />
              <span className="text-[10px] font-bold text-slate-600 uppercase">Reconciliation</span>
            </button>
            <button onClick={() => navigate('/integration/activity-audit')} className="flex flex-col items-center justify-center p-4 bg-slate-50 border border-slate-300 rounded-md hover:border-sky-400 hover:bg-sky-50 transition-all group cursor-pointer">
              <Activity className="h-5 w-5 text-slate-400 group-hover:text-sky-600 mb-2" />
              <span className="text-[10px] font-bold text-slate-600 uppercase">Activity Audit</span>
            </button>
          </div>
        </div>
      </div>
