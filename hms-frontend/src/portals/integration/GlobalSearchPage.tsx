...
export const GlobalSearchPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-black text-slate-800 tracking-tight">Global Search</h2>
        <p className="text-xs text-slate-500 font-medium">Cross-portal search with role-aware result filtering</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        {isLoading && debouncedQuery ? (
          <div className="p-10 text-center text-sm font-medium text-slate-500">Searching...</div>
        ) : error ? (
          ...
          <div className="p-10 text-center text-sm font-medium text-slate-500">No results found for "{debouncedQuery}".</div>
        ) : !debouncedQuery ? (
           <div className="p-10 text-center text-sm font-medium text-slate-500">Type above to search across domains...</div>
        ) : (
