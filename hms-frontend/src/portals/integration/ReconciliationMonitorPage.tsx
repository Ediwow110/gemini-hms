...
export const ReconciliationMonitorPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-black text-slate-800 tracking-tight">Reconciliation Monitor</h2>
        <p className="text-xs text-slate-500 font-medium">Cross-domain mismatch detection and resolution tracking</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        {isLoading ? (
          <div className="p-10 text-center text-sm font-medium text-slate-500 col-span-full">Loading reconciliation issues...</div>
        ) : error ? (
          ...
          <div className="p-10 text-center text-sm font-medium text-slate-500 col-span-full">No reconciliation issues found.</div>
        ) : (
          issues.map((issue) => (
