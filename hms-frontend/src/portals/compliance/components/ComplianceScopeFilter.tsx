...
/** Display-only scope label — compliance scope is JWT-derived; mock tenant/branch pickers are not wired. */
export const ComplianceScopeFilter: React.FC = () => {
  return (
    <div
      ...
      aria-label="Compliance scope (display only — not wired)"
      title="Scope filter is not wired in this release"
      data-testid="compliance-scope-filter"
    >
      <Filter className="h-4 w-4 text-slate-400" />
      <span className="font-medium text-xs">Compliance Scope (Session Tenant)</span>
