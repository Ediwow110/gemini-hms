  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Branch Audit Logs', to: '/audit-logs', icon: History, allowedRoles: ['Branch Admin'], zone: 'staff' },
      {
        ...
        zone: 'staff',
        children: [
          { label: 'Branches', to: '/settings/branches', icon: Building, allowedRoles: ['Branch Admin'], zone: 'staff' },
          { label: 'Departments', to: '/settings/departments', icon: Box, allowedRoles: ['Branch Admin'], zone: 'staff' },
          { label: 'Services & Packages', to: '/settings/services', icon: Stethoscope, allowedRoles: ['Branch Admin'], zone: 'staff' },
          { label: 'Numbering Rules', to: '/settings/numbering', icon: ListOrdered, allowedRoles: ['Branch Admin'], zone: 'staff' },
          { label: 'Print Templates', to: '/settings/templates', icon: FileText, allowedRoles: ['Branch Admin'], zone: 'staff' },
          { label: 'Notifications', to: '/settings/notifications', icon: MessageSquare, allowedRoles: ['Branch Admin'], zone: 'staff' },
          { label: 'Security', to: '/settings/security', icon: ShieldCheck, allowedRoles: ['Branch Admin'], zone: 'staff' },
        ],
      },
    ],
  },
