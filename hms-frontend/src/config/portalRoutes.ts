...
export const portalRoutes: RouteGuardConfig[] = [
  ...
  { path: 'marketplace', zone: 'marketplace' },
  { path: 'marketplace/products', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },
  { path: 'marketplace/products/:productId', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },
  { path: 'marketplace/compare', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },
  { path: 'marketplace/cart', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },
  { path: 'marketplace/checkout', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },
  { path: 'marketplace/rfqs', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },
  { path: 'marketplace/orders', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },
  { path: 'marketplace/deliveries', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },
  { path: 'marketplace/installations', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },
  { path: 'marketplace/warranty', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },
  { path: 'marketplace/service-tickets', allowedRoles: ['Super Admin', 'Branch Admin', 'Marketplace Buyer', 'Customer'], zone: 'marketplace' },

  // Marketplace Supplier Zone
  { path: 'supplier', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  { path: 'supplier/listings', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  { path: 'supplier/service-listings', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  { path: 'supplier/rfq-inbox', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  { path: 'supplier/quotes', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  { path: 'supplier/orders', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  { path: 'supplier/fulfillment', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  { path: 'supplier/warranty-claims', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  { path: 'supplier/service-commitments', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  { path: 'supplier/payouts', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  { path: 'supplier/performance', allowedRoles: ['Super Admin', 'Branch Admin', 'Supplier', 'Supplier Admin', 'Marketplace Supplier'], zone: 'marketplace' },
  ...
  { path: 'branch-admin', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
  { path: 'branch-admin/staff', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
  { path: 'branch-admin/departments', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
  { path: 'branch-admin/rooms', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
  { path: 'branch-admin/schedules', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
  { path: 'branch-admin/services', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
  { path: 'branch-admin/equipment', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
  { path: 'branch-admin/inventory-rules', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
  { path: 'branch-admin/billing-rules', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
  { path: 'branch-admin/queue-settings', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
  { path: 'branch-admin/approvals', allowedRoles: ['Branch Admin'], zone: 'staff', isBranchScoped: true },
